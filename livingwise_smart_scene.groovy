 ...
 *
 *	Author: Leif GIlbertson based on Matt Frank based on VRCS Button Controller by Brian Dahlem, based on SmartThings Button Controller
 ...
 */
 ...
 metadata {
  ...
  definition (name: "Orvibo/LIVINGwise 7 Button Scene Controller", namespace: "youodysseyleif", author: "Leif GIlbertson") {
        capability "Actuator"
        capability "Button"
