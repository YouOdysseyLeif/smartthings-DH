...
metadata {
    ...
    simulator {
        ...
        status "button 5 pushed":  "command: 2001, payload: 79"
        status "button 5 held":  "command: 2001, payload: 8D"
        status "button 6 pushed":  "command: 2001, payload: 79"
        status "button 7 held":  "command: 2001, payload: 8D"
        status "button 7 pushed":  "command: 2001, payload: 79"
        status "button 7 held":  "command: 2001, payload: 8D"
